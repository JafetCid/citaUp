...
export default function Appoitments({ style, contatcStyle, isSubmitting, handleSubmit, handleInputChange, formData, errors }: PropsAppointments) {
    return (
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-8">
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    {/* <motion.button
                                        ...
                                        whileTap={{ scale: 0.98 }}
                                        className="w-full cursor-pointer bg-blue-600 text-white py-2.5 px-6 rounded-lg font-semibold text-lg hover:bg-blue-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {isSubmitting ? (

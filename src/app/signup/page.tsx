				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					...
					<div>
						<div className="max-w-md mx-auto">
							<h1 className="text-2xl lg:text-3xl font-extrabold">Regístrate</h1>
							<p className="text-sm text-slate-600 mt-2">Crea una cuenta y comienza a gestionar tus citas en segundos.</p>

							<form className="mt-6 bg-white rounded-2xl p-6 shadow-md space-y-4">
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									<label className="flex flex-col">
										<span className="text-sm font-medium text-slate-700">Nombre</span>
										<input name="firstName" type="text" required placeholder="Nombre" className="mt-1 px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-sky-200" />
									</label>

									<label className="flex flex-col">
										<span className="text-sm font-medium text-slate-700">Apellido</span>
										<input name="lastName" type="text" required placeholder="Apellido" className="mt-1 px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-sky-200" />
									</label>
								</div>
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									...
									<label className="flex flex-col">
										...
										<input name="confirmPassword" type="password" required placeholder="Confirmar contraseña" className="mt-1 px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-sky-200" />
									</label>
								</div>

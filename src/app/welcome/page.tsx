...
export default function Bienvenida() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-white via-sky-50 to-indigo-50 text-slate-900">
      {/* <NavAlt /> */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <aside className="space-y-6">
            ...
            <div className="hidden lg:block bg-white rounded-2xl p-6 shadow-lg text-center">
              <Image src="/assets/CitaUp 4 (1).png" alt="avatar" width={180} height={140} className="mx-auto rounded-md" />
